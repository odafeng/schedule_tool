...
def render_export_section(publisher, weekdays, holidays):
    ...
    with col3:
        ...
        if line_client:
            ...
            # 測試連線按鈕
            with st.expander("🔧 LINE Bot 設定", expanded=False):
                if st.button("測試連線", key="test_line_connection"):
                ...
                **注意事項：**
                - 訊息會發送給所有追蹤 Bot 的使用者
                - Flex Message 提供更豐富的視覺效果
                - 請確保 Channel Access Token 有效
                """)
        else:
